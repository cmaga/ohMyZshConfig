...
.PHONY: help setup deploy deploy-zsh deploy-git deploy-cline finalize lint
.DEFAULT_GOAL := help
...
deploy: deploy-zsh deploy-git deploy-cline finalize ## Deploy all configs (zsh, git, cline)
