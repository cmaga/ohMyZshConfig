...
- [AgentOS SDK for APK V0.4.5 Documentation](#agentos-sdk-for-apk-v045-documentation)
...
- [2. Action Details](#2-action-details)
  - [2.1 Action Concept](#21-action-concept)
    - [Action Planning Mechanism](#action-planning-mechanism)
    - [Naming Specification Constraints](#naming-specification-constraints)
  ...
  - [2.2 Action Registration Mechanism](#22-action-registration-mechanism)
    - [Action Activation Mechanism](#action-activation-mechanism)
    ...
    - [2.2.2 Page-Level Action](#222-page-level-action)
      - [Dynamic Registration](#dynamic-registration-1)
      - [Action Filtering Mechanism](#action-filtering-mechanism)
  - [2.3 Action Execution Flow](#23-action-execution-flow)
    - [2.3.1 Execution Callback](#231-execution-callback)
    - [2.3.2 Action Execution Completion Notification](#232-action-execution-completion-notification)
  - [2.4 System Built-in Actions](#24-system-built-in-actions)
    - [Knowledge Base Question Answering Usage Example](#knowledge-base-question-answering-usage-example)
- [3. Agent Role Configuration - Personalize Your AI](#3-agent-role-configuration---personalize-your-ai)
  ...
  - [3.2 Three Core Configurations](#32-three-core-configurations)
    - [Persona Configuration (setPersona)](#persona-configuration-setpersona)
    - [Style Configuration (setStyle)](#style-configuration-setstyle)
    - [Objective Configuration (setObjective)](#objective-configuration-setobjective)
  ...
  - [3.7 Typical Application Scenarios](#37-typical-application-scenarios)
    ...
    - [Educational Application](#educational-application)
- [4. Core API Interfaces](#4-core-api-interfaces)
  ...
  - [4.2 Wake-Free Functionality](#42-wake-free-functionality)
    - [Feature Introduction](#feature-introduction-1)
  ...
  - [4.3 ASR and TTS Listening](#43-asr-and-tts-listening)
    - [Feature Introduction](#feature-introduction-2)
    - [Application Scenarios](#application-scenarios-2)
    - [API Interface](#api-interface-2)
    - [Usage Explanation](#usage-explanation)
  - [4.4 Agent Status Listening](#44-agent-status-listening)
    - [Feature Introduction](#feature-introduction-3)
    - [API Interface](#api-interface-3)
    - [Status Explanation](#status-explanation)
  - [4.5 Voice Bar Control](#45-voice-bar-control)
    - [Feature Introduction](#feature-introduction-4)
    - [API Interface](#api-interface-4)
  - [4.6 TTS Speech Synthesis](#46-tts-speech-synthesis)
    - [Feature Introduction](#feature-introduction-5)
    - [Application Scenarios](#application-scenarios-3)
    - [API Interface](#api-interface-5)
    - [Important Notes](#important-notes)
  - [4.7 TTS Audio File Playback](#47-tts-audio-file-playback)
    - [Feature Introduction](#feature-introduction-6)
    - [Technical Features](#technical-features)
    - [Application Scenarios](#application-scenarios-4)
    - [API Interface](#api-interface-6)
    - [Callback Interface Definition](#callback-interface-definition)
    - [Usage Example](#usage-example)
    - [Difference from Streaming TTS](#difference-from-streaming-tts)
    - [Important Notes](#important-notes-1)
  - [4.8 Large Language Model (LLM) Interface](#48-large-language-model-llm-interface)
    - [Feature Introduction](#feature-introduction-7)
    - [API Interface](#api-interface-7)
  - [4.9 Text Commands](#49-text-commands)
    - [Feature Introduction](#feature-introduction-8)
    - [Application Scenarios](#application-scenarios-5)
    - [API Interface](#api-interface-8)
  - [4.10 Perception Information Reporting](#410-perception-information-reporting)
    - [Feature Introduction](#feature-introduction-9)
    - [Application Scenarios](#application-scenarios-6)
    - [API Interface](#api-interface-9)
  - [4.11 Conversation History Management](#411-conversation-history-management)
    - [Feature Introduction](#feature-introduction-10)
    - [Application Scenarios](#application-scenarios-7)
    - [API Interface](#api-interface-10)
  - [4.12 Disable Large Language Model Planning](#412-disable-large-language-model-planning)
    - [Feature Introduction](#feature-introduction-11)
    - [API Interface](#api-interface-11)
  - [4.13 Application Switching](#413-application-switching)
    - [Feature Introduction](#feature-introduction-12)
    - [API Interface](#api-interface-12)
  - [4.14 System Action Status Listening](#414-system-action-status-listening)
    - [Feature Introduction](#feature-introduction-13)
    - [API Interface](#api-interface-13)
    - [Usage Example](#usage-example-1)
  - [4.15 Wake Word Mode Control](#415-wake-word-mode-control)
    - [Feature Introduction](#feature-introduction-14)
    - [Core Interfaces](#core-interfaces)
      - [enableWakeupMode()](#enablewakeupmode)
      - [setWakeupVadTimeout()](#setwakeupvadtimeout)
      - [setWakeupQuestionTimeout()](#setwakeupquestiontimeout)
    - [Usage Explanation](#usage-explanation-1)
- [5. Advanced Features](#5-advanced-features)
  - [5.1 Annotation-Driven Action Registration](#51-annotation-driven-action-registration)
    - [Feature Introduction](#feature-introduction-15)
    ...
    - [5.1.3 Annotation Class Description](#513-annotation-class-description)
      - [@AgentAction Annotation](#agentaction-annotation)
      - [@ActionParameter Annotation](#actionparameter-annotation)
...
- [7. Project Resources](#7-project-resources)
  - [7.1 Sample Projects](#71-sample-projects)
    ...
    - [Complete Sample Project](#complete-sample-project)
  - [7.2 Development Resources](#72-development-resources)
    - [Reception Backend](#reception-backend)
...
- **Multi-user scenario risk**: Simultaneous dialogue by different users easily produces speech conflicts and misrecognition
...
> - **Setting timeout too short may interrupt long text playback**. Recommend setting timeout reasonably based on text length
...
> **Important Tip**: `uploadInterfaceInfo` uses **overwrite update** mechanism
>
...
> **Important Reminder**: Action design quality directly affects the large language model's understanding and execution. Poor design may result in features not triggering correctly, parameter parsing errors, poor user experience, etc. Please strictly follow the best practice principles in this section.
