...
- The mock-first prototype go/no-go was decided at Step 3's Data-presentation checkpoint — do not re-raise it here. If a prototype was built, carry its approved shape and the data contract it pins into the plan's task cards.
