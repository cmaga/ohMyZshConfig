...
> - **Record friction with the skill as it happens** — per [friction](friction.md), any place its text underdetermined what you did and you had to decide. Nobody can reconstruct that from your report, and you are the only one who was there. Write the entry and carry on; never return it to me or wait on it.
